...
(define stimuli
  (list
   ...
   'sword-3
   (read "Make a game with a fully customized lightsaber.")

   'sword-4
   (read "Make a game that has a customizable blaster in it where you can modify its speed, range, and sprite.")
