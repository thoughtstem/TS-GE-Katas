...
Instead of working on one large game, K-2nd students work on individual challenge cards,
trying to build as many games back-to-back as they can!

@section{Partnering Up}

Working in pairs is recommended whenever possible -- two brains working on the same code
often leads to higher achievement! However, in smaller classes this doesn't always work.
If you cannot make it mandatory, at least make it an option! Here are some tips when pairing
students up, whether you make it optional or not:

@itemlist[@item{Give the students advance notice that they will be/might be working in
                pairs. This helps students who don't adjust to change very well.}
          ...
          @item{Have students switch "drivers" (who is typing) every 3 minutes. Set a
                timer and just keep running it, instructing students to swap every time it
                goes off.}
...
that flipping a card over without paying up is cheating and keep an eye out as best they can
during the jam. Students will probably speak up @italic{very loudly} if they think they
see someone else breaking this rule. Offer reminders when needed, but only repercussions
when you see cheating with your own eyes.
...
Split the time of Game Jam between the K-2 langs they have worked with -- spend the
first 15/20 minutes with the more basic language, then shift the students to the harder
lang after they finish the card they are working on!
...
@itemlist[@item[@bold{Call in a Coach!} " -- for " @bold{10 ThoughtSTEM dollars} ", any student can
...
@itemlist[@item[@bold{Support the students} " by offering words of encouragement, advice on how to
          ...
          @item["Trade out challenge cards, and award stickers for every completion."]
...
Students will need a little more guidance in scoring, but should still participate
and help their coach!

@itemlist[#:style 'ordered
          @item["Count up the total number of challenge cards each student/pair of student
                completed." @bold{ Keep track of these during the Jam with stickers on
                index cards!}]
