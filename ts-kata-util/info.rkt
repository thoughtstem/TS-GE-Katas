...
(define raco-commands
  '(("build-lang-examples" ts-kata-util/raco-tools/raco-build-examples "runs kata-definition files, runs tests, builds documentation" 100)
    ("build-kata-docs"     ts-kata-util/raco-tools/raco-build-docs "(re)builds the docs for a kata collection" 100)
