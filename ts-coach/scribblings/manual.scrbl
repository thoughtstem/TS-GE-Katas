...
2) @bold{Your own coding ability.}  This is also a lifelong journey.  You can strengthen your coding skills by doing the exact same katas you'll be teaching to students.
...
Of course, when teaching a classroom full of students, it can be difficult to guide every
student through the four phases flawlessly.  But good news: 1) Flawlessness is not required,
and 2) practice will help you become more and more skillful.

Here are some "meta katas" to test your understanding of what a kata is and how you're supposed to use them.

@(render #:level subsubsection meta-katas)
...
@(render #:level subsubsection teaching-katas)

@section{Coding Katas}

@(render  #:level subsection fundamentals-katas)
